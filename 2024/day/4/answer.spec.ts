...
describe('Does the parser work?', () => {
    effect('year 2024 - day 4 - should return the correct answer', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2024/day/4/snippet-1.txt');
...
describe('Are the examples working?', () => {
    effect('year 2024 - day 4 - part 1 - snippet 1', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2024/day/4/snippet-1.txt');
    ...
    effect('year 2024 - day 4 - part 2 - snippet 1', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2024/day/4/snippet-1.txt');
