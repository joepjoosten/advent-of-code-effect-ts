...
describe('year 2024 - day 14 - does the parser work?', () => {
    effect('should return the correct answer', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2024/day/14/part-1-snippet-1.txt');
...
describe('year 2024 - day 14 - are the examples working?', () => {
