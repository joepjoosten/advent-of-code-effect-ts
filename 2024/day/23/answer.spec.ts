...
describe('year 2024 - day 23 - does the parser work?', () => {
    effect('should return the correct answer', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2024/day/23/part-1-snippet-1.txt');
...
describe('year 2024 - day 23 - are the examples working?', () => {
