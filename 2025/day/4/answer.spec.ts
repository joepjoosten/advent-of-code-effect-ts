...
describe('year 2025 - day 4 - does the parser work?', () => {
    effect('should return the correct answer', () => Effect.gen(function* () {
        const fs = yield* FileSystem.FileSystem;
        const snippet = yield* fs.readFileString('./2025/day/4/part-1-snippet-1.txt');
...
describe('year 2025 - day 4 - are the examples working?', () => {
